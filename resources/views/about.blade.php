...
@section('content')
    ...
    <div class="sm:grid grid-cols-2 gap-10 w-4/5 mx-auto py-15">
        <div class="text-center">
            <!-- Removed the image -->
            <h2 class="text-3xl font-bold mt-5 text-purple-600">Our Journey</h2>
        ...
        <div class="text-center">
            <!-- Removed the image -->
            <h2 class="text-3xl font-bold mt-5 text-purple-600">Our Vision</h2>
            <p class="text-gray-700 mt-3 leading-relaxed">
    ...
    <div class="bg-gray-50 py-20">
        <div class="w-4/5 mx-auto text-center">
            <h2 class="text-4xl font-bold text-purple-700">Our Mission</h2>
    ...
    <!-- Call to Action -->
    <div class="bg-gradient-to-r from-yellow-500 to-purple-500 text-white text-center py-20">
        ...
        <a href="/blog" class="mt-6 inline-block bg-purple-500 text-white font-bold py-3 px-8 rounded-full shadow-lg hover:bg-purple-600 transition duration-300">
            Explore Our Blog
        </a>
    </div>
@endsection
