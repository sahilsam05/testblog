...
<div class="container mx-auto py-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-white shadow-lg rounded-lg p-6">
            <img src="https://via.placeholder.com/300x200" alt="Classic Leather Jacket" class="w-full h-48 object-cover rounded-md mb-4">
        ...
        <!-- Item 2 -->
        <div class="bg-white shadow-lg rounded-lg p-6">
            <img src="https://via.placeholder.com/300x200" alt="Vintage Denim Jeans" class="w-full h-48 object-cover rounded-md mb-4">
        ...
        <!-- Item 3 -->
        <div class="bg-white shadow-lg rounded-lg p-6">
            <img src="https://via.placeholder.com/300x200" alt="Silk Scarf Collection" class="w-full h-48 object-cover rounded-md mb-4">
